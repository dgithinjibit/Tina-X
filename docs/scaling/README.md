...
TINA-X's thesis is the **opposite regime** from the book: tiny edge agents, symbolic reasoning,
...
## Chapter-by-chapter applicability to TINA-X
| Chapter | Applies to TINA-X? | What we do |
|---|---|---|
...
| TPU hardware | ❌ No | TINA-X runs on CPUs/microcontrollers, not TPUs |
...
If TINA-X ever trains/serves a **large** learned model (a big weather nowcaster or vision model),
